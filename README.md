...
- ✔️ Landing page moderna creada con **Angular standalone components**  
- ✔️ Arquitectura organizada por módulos y carpetas  
- ✔️ Consumo real de datos desde **TheSportsDB API**  
- ✔️ Visualización de próximos partidos por liga  
- ✔️ Conversión de horario automático a zona horaria de México  
- ✔️ Diseño responsivo con **Flexbox**, **Grid** y **Media Queries**  
- ✔️ Logos dinámicos de equipos y ligas  
- ✔️ Estética limpia, modular y funcional  
...
| **TheSportsDB API** | Datos deportivos en tiempo real |
